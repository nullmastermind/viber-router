...
- **THEN** the page SHALL show a table with columns: server name, model, total input tokens, total output tokens, total cache creation tokens, total cache read tokens, request count, and cost ($)
...
- **THEN** the cost column SHALL display "—"
