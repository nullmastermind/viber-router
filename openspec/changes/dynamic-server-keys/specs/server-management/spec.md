...
The system SHALL allow creating a new upstream server with name and base_url as required fields, and api_key as an optional field. The system SHALL auto-assign a unique short_id (auto-increment integer).
