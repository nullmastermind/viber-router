...
This project is indexed by GitNexus as **viber-router** (1453 symbols, 2153 relationships, 72 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
