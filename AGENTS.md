...
Instructions for all AI agents and coding assistants working on this repository.
...
This project is indexed by GitNexus as **viber-router** (1521 symbols, 2235 relationships, 72 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
