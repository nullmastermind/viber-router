...
export const useServersStore = defineStore('servers', () => {
  ...
  async function createServer(input: { name: string; base_url: string; api_key?: string; password?: string }) {
  ...
  async function updateServer(
    id: string,
    input: { name?: string; base_url?: string; api_key?: string | null; password?: string | null },
  ) {
